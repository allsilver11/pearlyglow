...
public class MembersDao {
	...
	public void lockY200(String id) {
		Connection con=null;
		PreparedStatement pstmt1=null;
		PreparedStatement pstmt2=null;
		ResultSet rs=null;
		String sql1="select * from members where sysdate-recentacc>=200";
		String sql2="update members set issleep='Y' where id=?";
		int cnt=0;
		try {
			con=DBCPBean.getConn();
			...
			while(rs.next()) {
				...
				pstmt2.addBatch(); //배치에 실행할 sql구문 담기
